...
$(window).on('scroll , load',function(){
	...
	/* ------ hero section fadeOut ------*/

	var top_sec_hight = $("#top_section").outerHeight();
	$("#top_section").css("opacity", 1 - ( window_top / top_sec_hight ) );
...
$("#contact_form").submit(function(t){
	t.preventDefault();
